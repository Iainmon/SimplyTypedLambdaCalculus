...
instance ToJSON Expr where
  toJSON (Lit v _)     = object [ruleText .= str "Lit", "name" .= v]
  toJSON (Lam v b _)   = object [ruleText .= str "Lam", "var" .= v, "body" .= b]
  toJSON (App l r _)   = object [ruleText .= str "App", "lhs" .= l, "rhs" .= r]
